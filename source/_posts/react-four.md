---
title: React笔记四：excel导出与导入
date: 2020-07-07 18:34:34
tags: [React]
categories: [React]
meta:
...
### 应用
```
import ExcelUtil from "../../component/ExcelUtil/ExcelUtil";
<Button type="primary" onClick={() => {ExcelUtil.exportExcel(columns, this.state.taskListData,"结果.xlsx")}}>导出</Button>
```